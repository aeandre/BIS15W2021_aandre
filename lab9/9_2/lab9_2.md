...
```
## # A tibble: 2 x 4
##   trophic.guild min_log10_mass max_log10_mass median_log10_mass
##   <chr>                  <dbl>          <dbl>             <dbl>
...
```
## # A tibble: 94 x 3
##    family         min_log10_mass max_log10_mass
##    <chr>                   <dbl>          <dbl>
##  1 accipitridae            2.15           3.48 
##  2 acrocephalisae          1.04           1.04 
##  3 aegithalidae            0.903          0.903
##  4 alaudidae               1.48           1.48 
##  5 anguillidae             2.95           2.95 
##  6 apterygidae             3.37           3.37 
##  7 ardeidae                1.83           2.95 
##  8 canidae                 3.32           4.44 
##  9 caprimulgidae           1.68           1.68 
## 10 carangidae              2.86           2.86 
## # … with 84 more rows
```
