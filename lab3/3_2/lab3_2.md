...
```
## [1] "/Users/allyandre/Desktop/BIS 15L/lab3/3_2"
```
...
Why? What is the difference between a factor and a character? A factor would read "17" as "17," while a character would read it as "1" and "7." A character is a string of text, while factors have levels. 
...
We can summarize our data frame with the`summary()` function.  This can have problems with NA data
