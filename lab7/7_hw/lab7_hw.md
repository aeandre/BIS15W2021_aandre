...
In the amniota dataset, the NA's are represented by -999. In the amphibio dataset, the NA's are listed as NA's
...
It makes sense that 100% of mammals would have an egg mass of NA because they don't lay eggs. I am surprised that such a high percentage of birds and reptiles had NA for their egg mass, which leads me to believe that some of the NAs have biological significance, but some may be because the measurements haven't been performed, etc. 
...
I think that these NAs are not missing data, but rather signify which groups that the species in question does not belong to. It is a binary system, where NA means that the label doesn't apply, and 1 means that it does.
...
## #   male_svl_cm <lgl>, female_svl_cm <lgl>, birth_or_hatching_svl_cm <lgl>,
## #   female_svl_at_maturity_cm <lgl>, female_body_mass_at_maturity_g <lgl>,
## #   no_sex_svl_cm <lgl>, no_sex_maturity_d <dbl>
```
