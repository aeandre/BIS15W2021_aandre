...
```
## # A tibble: 1 x 6
##   species mean_bill_lengt… mean_bill_depth… mean_flipper_le… mean_body_mass_g
##   <fct>              <dbl>            <dbl>            <dbl>            <dbl>
## 1 Adelie              38.8             18.3             190.            3701.
## # … with 1 more variable: n_penguins <int>
```
...
```
## # A tibble: 3 x 5
##   species   bill_length_mm bill_depth_mm flipper_length_mm number
##   <fct>              <dbl>         <dbl>             <dbl>  <int>
