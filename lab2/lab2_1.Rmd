...
I interpret this result to mean that the mean cannot be calculated without having a value for the NAs. This suggests that NAs may be used as variables.

4. Recalculate the mean using the following code chunk. Why is the useful?

It is useful because it allows us to calculate the mean of all the known values in a vector.
```{r}
