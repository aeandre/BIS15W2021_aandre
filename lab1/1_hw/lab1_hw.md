...
#R studio is the programming language that we will be using in this class, while RStudio is the interface that allows easier and more intuitive interaction with the software. Github is a website where programmers can store, share, and collaborate on projects.
